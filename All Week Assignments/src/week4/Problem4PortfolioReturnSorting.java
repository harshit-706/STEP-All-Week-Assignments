...
public class Problem4PortfolioReturnSorting {
    ...
    public static void main(String[] args) {
        ...
        PortfolioSortingService.mergeSort(mergeArray, 0, mergeArray.length - 1);
        System.out.println("Merge Sort:");
        PortfolioSortingService.printArray(mergeArray);

        Asset[] quickArray = assets.clone();
        PortfolioSortingService.quickSort(quickArray, 0, quickArray.length - 1);
        System.out.println("Quick Sort:");
        PortfolioSortingService.printArray(quickArray);
    }
}